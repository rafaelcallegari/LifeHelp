...
public class ListaFisio extends AppCompatActivity implements MyAdpter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_fisio);

        TextView NomeProfisao = (TextView) findViewById(R.id.NomeProfisao);

        NomeProfisao.setText("Fisiotarapeuta");
        ...
        myAdpter = new MyAdpter(ListaFisio.this,profissionalArrayList, this);
    ...
    private void EventChangeListener() {
        db.collection("profissional").whereEqualTo("especialidade", "fisioterapia").orderBy("nome", Query.Direction.ASCENDING)
    ...
    public void OnNoteClick(int position) {
        Intent intent = new Intent(ListaFisio.this, PerfilLista.class);
