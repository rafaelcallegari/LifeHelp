...
public class ListaEnfermeiro extends AppCompatActivity implements MyAdpter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NomeProfisao.setText("Enfermeiros");
        ...
        myAdpter = new MyAdpter(ListaEnfermeiro.this,profissionalArrayList, this);
    ...
    private void EventChangeListener() {
        db.collection("profissional").whereEqualTo("especialidade", "enfermeiro").orderBy("nome", Query.Direction.ASCENDING)
    ...
    public void OnNoteClick(int position) {
        Intent intent = new Intent(ListaEnfermeiro.this, PerfilLista.class);
