...
public class ListaProfissional extends AppCompatActivity implements MyAdpter.OnNoteListener {
   ...
   ProgressDialog progressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdpter = new MyAdpter(ListaProfissional.this,profissionalArrayList, this);
    ...
    private void EventChangeListener() {
        db.collection("profissional").orderBy("nome",Query.Direction.ASCENDING)
    ...
    public void OnNoteClick(int position) {
        Intent intent = new Intent(ListaProfissional.this, PerfilLista.class);
