...
public class ListaCuidador extends AppCompatActivity implements MyAdpter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdpter = new MyAdpter(ListaCuidador.this,profissionalArrayList, this);
    ...
    private void EventChangeListener() {
        db.collection("profissional").whereEqualTo("especialidade", "cuidador").orderBy("nome",Query.Direction.ASCENDING)
    ...
    public void OnNoteClick(int position) {
        Intent intent = new Intent(ListaCuidador.this, PerfilLista.class);
